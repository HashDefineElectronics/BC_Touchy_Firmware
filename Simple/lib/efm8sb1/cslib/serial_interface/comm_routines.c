...
void printOutputSingAct(uint16_t offset, uint8_t bytes)
{
	volatile uint8_t index, output;
	uint8_t xdata *ptr;
	   //*((char code *) 0x8000)
	(0, bytes); // unreferenced variable
...
void printOutputDebAct(uint16_t offset, uint8_t bytes)
{
	volatile uint8_t index, output;
	uint8_t xdata *ptr;
	   //*((char code *) 0x8000)
...
void printOutputTDelta(uint16_t offset, uint8_t bytes)
{
	uint8_t index;
	uint8_t xdata *ptr;
  (0, bytes); // unreferenced variable
